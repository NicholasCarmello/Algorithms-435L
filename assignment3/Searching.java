...
public class Searching {
    ...
    public static void hashTable(String randomItems[], String array[]) {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            //This checks to see if there isn't an item in the indice and then adds the first node if there isn't
            if (newArray[getHashCode] == null) {
                ...
                //This will find the last position in the linked list and will add the new node to the end.
                newNode.name = array[i];
    ...
    public static void hashTableLookup(String[] randomitems, Node[] array) {
        ...
        for (int i = 0; i < randomitems.length; i++) {
            ...
            //this checks if the current node or the first node in the linked list is the item.
            if (current.name == randomitems[i]) {
                averageLookUpTime += 1;
                continue;
            } else {
                //This goes through every node in the lniked list until it finds the correct item.
        ...
        //This prints out of the total divided by the number of random items in the array.
